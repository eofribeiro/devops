		...
		try {
			...
			if (progExec != null) {
				...
				if (isDebug()) {
					...
					//strRet = efetuaComunicacaoGetEncoding(url, dadosAplic, dadosPost, Jasppion);//NAO DEU CERTO -- DESCOLOCOU A SAÍDA
...
//				String urlNova = url + "?" + dadosAplic + dadosPost + "!" + Jasppion + "_fim_de_dados!";
//				//String urlNova = url + "?" + dadosAplic + URLEncoder.encode(dadosPost, "ISO-8859-1") + "!" + Jasppion + "_fim_de_dados!"; // NÃO DEU CERTO				
//				urlNova = urlNova.replaceAll("[ ]", "%20");
//				
